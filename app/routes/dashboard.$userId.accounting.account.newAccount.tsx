            ...
            <Form method="post" className="w-full h-full grid mt-5">
                <div className="grid grid-cols-2 gap-2">
                    <div className="flex flex-col mt-4 gap-3">
                        <Input type="text" required name="accountName" labelPlacement="outside" variant="faded" label="Account Name" />
                        <Input type="text" required name="accountNumber" labelPlacement="outside" variant="faded"  label="Account Number"  />
                        <Input type="text" required name="accountType" labelPlacement="outside" variant="faded" label="Account Type"  />
                    </div>
                    <div className="flex flex-col mt-4 gap-3">
