    ...
    return (
        <>
            <Form className="flex flex-row mt-5 ">
                <input
                    type="text"
                    className="bg-bgLightGray rounded-md h-8 pl-3 w-40 mr-4 outline-none"
                    placeholder="Id"
                />
                <input
                    type="text"
                        ...
                        {accountData.map((account: any, index: number) => (
                            <TableRow key={account.id}>
                                ...
                                <TableCell>
                                    <div
                                        className={`${
                                            account.status === "ACTIVE" ? "bg-green-300" : "bg-red-300"
                                        } rounded-lg p-1 w-16 flex justify-center items-center`}
                                    >
