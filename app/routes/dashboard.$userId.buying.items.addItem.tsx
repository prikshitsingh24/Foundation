...
import { createItem } from "services/dashboard/item";
...
export default function AddItem(){
    ...
    const [barcodeList,setBarcodeList]:any = useState<{barcode:string,barcodeType:string,uom:string} | any>([]);
    ...
    const [supplierList,setSupplierList]:any = useState<{supplier:string,supplierPartNumber:string} | any>([]);
    ...
    const [customerList,setCustomerList]:any = useState<{customerName:string,customerGroup:string,refCode:string} | any>([]);
    ...
    const [taxList,setTaxList]:any = useState<{itemTaxTemplate:string,taxCategory:string,validFrom:string,minimumNetRate:string,maximumNetRate:string} | any>([]);
